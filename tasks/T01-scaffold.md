# T01 — Workspace skeleton, toolchain pin, CI, and lint config
...
Commit: `feat(scaffold): implement workspace skeleton, toolchain pin, ci, and lint config`

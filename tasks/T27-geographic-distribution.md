...
> **Depends on**: T-canary-shards, T-port-traits.
...
Update PROGRESS.md row for T27 to `[x]`.
Commit: `feat(geographic-distribution): implement geographic threshold distribution manifests`

...
> **Depends on**: T-reed-solomon, T-stego-lsb-image, T-pdf-pipeline, T-canary-shards, T-geographic-distribution.
...
Update PROGRESS.md row for T29 to `[x]`.
Commit: `feat(distribution): implement four distribution patterns: 1:1, 1:n, n:1, n:m — with canary and geographic support`
